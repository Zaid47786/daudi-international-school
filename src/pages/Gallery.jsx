...
const photos = [
  // Real DIS photos from YouTube videos
  { src: "https://i.ytimg.com/vi/qXYJYEKhXTY/maxresdefault.jpg", cat: "Events", title: "Republic Day Celebration – DIS", real: true },
  { src: "https://i.ytimg.com/vi/qXYJYEKhXTY/hqdefault.jpg", cat: "Events", title: "R-Day Celebration at DIS", real: true },
  { src: "https://i.ytimg.com/vi/2jNMuQs_GyY/maxresdefault.jpg", cat: "Events", title: "Teachers Day at DIS", real: true },
  { src: "https://i.ytimg.com/vi/2jNMuQs_GyY/hqdefault.jpg", cat: "Cultural", title: "Teachers Day Program", real: true },
  { src: "https://cdn.educonnectin.com/images/schools/school-24.jpg", cat: "Classrooms", title: "Students at DIS", real: true },

  // Supporting Unsplash images to fill out categories
            ...
            <AnimatePresence>
              {filtered.map((photo, i) => (
                ...
                >
                  ...
                  />
                  {photo.real && (
                    <div className="absolute top-2 left-2 z-10 bg-gold text-navy text-[10px] font-bold px-2 py-0.5 rounded-full">
                      DIS
                    </div>
                  )}
