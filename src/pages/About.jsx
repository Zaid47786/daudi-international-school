          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                DIS is committed to holistic development — academic excellence, character building, and community participation go hand in hand at our school. We believe that education is the most effective tool for social transformation.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
            ...
            >
              {[
                ...
                <div key={i} className={`${item.color === "bg-gold" ? "bg-gold text-navy" : `${item.color} text-white`} rounded-2xl p-6 flex flex-col gap-3`}>
                  <item.icon size={28} className={item.color === "bg-gold" ? "text-navy" : "text-gold"} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-6 bg-navy rounded-2xl p-5 shadow-xl">
                <div className="text-gold font-bold text-lg">Altamash Daudi</div>
            ...
            >
              ...
              <div className="text-5xl text-gold/30 font-playfair mb-2">"</div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Under the Daudi Welfare Trust, we have built an institution that combines modern pedagogy with traditional values. Our teachers are not just educators; they are mentors, guides, and role models for hundreds of young lives.
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-navy">Core Values</h2>
          </div>
            ...
            {milestones.map((m, i) => (
              ...
              >
                <div className="flex-1 md:w-1/2">
                  <div className={`bg-white/5 border border-white/10 rounded-xl p-5 ${i % 2 !== 0 ? "md:text-right" : ""}`}>
                    <div className="text-gold font-bold text-lg mb-1">{m.year}</div>
                    <p className="text-white/70 text-sm leading-relaxed">{m.event}</p>
                  </div>
                </div>
                <div className="absolute left-8 md:left-1/2 w-4 h-4 bg-gold rounded-full border-4 border-navy -translate-x-1/2 mt-5" />
