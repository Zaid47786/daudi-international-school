          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div>
                ...
                <p className="text-gray-500 text-sm leading-relaxed">
                  Visit us at our campus in Motijheel, Muzaffarpur, or reach us through any of the channels below.
                </p>
              </div>
              ...
              {[
                ...
                >
                  <div className="w-10 h-10 bg-royal-blue rounded-xl flex items-center justify-center flex-shrink-0">
                    <item.icon size={18} className="text-gold" />
                  </div>
                  <div>
                    <div className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-1">{item.label}</div>
                    {item.link ? (
                      <a href={item.link} className="text-navy font-medium text-sm hover:text-royal-blue transition-colors">
                        {item.content}
                      </a>
                    ) : (
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                {submitted ? (
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <button
                        type="submit"
                        className="w-full py-4 bg-royal-blue text-white font-bold rounded-xl hover:bg-navy transition-all duration-300 shadow-lg hover:scale-[1.02] text-sm"
                      >
                        Send Message
                      </button>
                    </form>
              ...
              <div className="rounded-3xl overflow-hidden shadow-xl border border-gray-100 h-72">
                <iframe
                  title="DIS Muzaffarpur Location"
